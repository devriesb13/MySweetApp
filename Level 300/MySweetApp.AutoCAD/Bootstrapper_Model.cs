...
using MySweetApp.AutoCAD.Services;
...
namespace MySweetApp.AutoCAD
{
    internal sealed class Bootstrapper : MySweetApplication
    {
        ...
        protected override void ConfigureApplicationModules(IModuleCatalog moduleCatalog)
        {
            ...
            moduleCatalog.AddModule<AutoCAD_Module>(typeof(AutoCAD_Module).FullName);
        ...
        {
            containerRegistry.RegisterSingleton<IFindData_Service, FindAutoCADData_Service>();
        }
